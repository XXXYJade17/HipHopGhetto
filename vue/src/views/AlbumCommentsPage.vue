<template>
  <div class="container py-8">
    ...
    <div class="flex items-center justify-between mb-8">
      <h1 class="text-3xl font-bold text-white">专辑评论</h1>
      <button
...
const fetchComments = async () => {
  try {
    ...
    const response = await albumApi.getAlbumComments({
      sortType: 'DEFAULT',
...
const submitComment = async () => {
  ...
  try {
    ...
    const response = await albumApi.createAlbumComment(requestData)
