...
@Component
@Slf4j
public class CommentCountIncreaseHandler implements MessageStrategy<Comment> {
        ...
        try {
            ...
            switch (comment.getParentType()) {
                case ResourceType.COMMENT -> {
                    commentService.increaseCommentCount(comment.getParentId());
    ...
    public String getMessageType() {
        return MessageType.COMMENT_COUNT_INCREASE;
    }
}